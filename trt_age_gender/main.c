...
main(int argc, char *argv[])
{
    ...
    init_trt_age_gender (&imgui_data.facedet_config);
    ...
    for (count = 0; ; count ++)
    {
        ...
        age_gender_result_t  age_gender_ret[MAX_FACE_NUM] = {0};
        char strbuf[512];
        ...
        invoke_face_detect (&face_detect_ret, &imgui_data.facedet_config);
        ...
        {
            feed_age_gender_image (&captex, win_w, win_h, &face_detect_ret, face_id);
