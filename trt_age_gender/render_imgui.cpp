...
render_gui (imgui_data_t *imgui_data)
{
    ...
    ImGui::SliderFloat("Score thresh", &imgui_data->facedet_config.score_thresh, 0.0f, 1.0f);
    ImGui::SliderFloat("IOU   thresh", &imgui_data->facedet_config.iou_thresh,   0.0f, 1.0f);
