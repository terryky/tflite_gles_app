...
#cp bazel-bin/tensorflow/lite/libtensorflowlite.so ~/lib/tf2.7
#cp bazel-bin/tensorflow/lite/delegates/gpu/libtensorflowlite_gpu_delegate.so ~/lib/tf2.7
