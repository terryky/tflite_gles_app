...
#define FACE_PORTRAIT_MODEL_PATH        "./model/model_float32.tflite"

#define FACE_DETECT_QUANT_MODEL_PATH    "./model/face_detection_front.tflite"
#define FACE_PORTRAIT_QUANT_MODEL_PATH  "./model/model_float32.tflite"
 ...
 * -------------------------------------------------- */
int
init_tflite_portrait(int use_quantized_tflite)
{
    const char *facedetect_model;
    const char *portrait_model;

    if (use_quantized_tflite)
    {
        facedetect_model = FACE_DETECT_QUANT_MODEL_PATH;
        portrait_model  = FACE_PORTRAIT_QUANT_MODEL_PATH;
    }
    else
    {
        facedetect_model = FACE_DETECT_MODEL_PATH;
        portrait_model = FACE_PORTRAIT_MODEL_PATH;
    }
    ...
    /* Selfie2Anime */
    tflite_create_interpreter_from_file (&s_interpreter, portrait_model);
