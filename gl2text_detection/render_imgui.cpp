...
{
    ImGui::Begin("Detection config");

    ImGui::SliderFloat("Score thresh", &imgui_data->detect_config.score_thresh, 0.0f, 1.0f);
    ImGui::SliderFloat("IOU   thresh", &imgui_data->detect_config.iou_thresh,   0.0f, 1.0f);
