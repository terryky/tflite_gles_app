                      ...
                      pose_detect_result_t *detection, imgui_data_t *imgui_data)
{
    ...
    for (int i = 0; i < detection->num; i ++)
    {
		...
		float sx = (region->topleft.x + region->btmright.x) * 0.5f;
		float sy = (region->topleft.y + region->btmright.y) * 0.5f;
		sx = sx * texw + ofstx;
		sy = sy * texh + ofsty;
                      ...
                      pose_detect_result_t *detection, unsigned int pose_id)
{
    ...
    /* right leg */
    render_bone (ofstx, ofsty, texw, texh, transformed_pos, 23, 25, col_pink);
    render_bone (ofstx, ofsty, texw, texh, transformed_pos, 25, 27, col_pink);
    render_bone (ofstx, ofsty, texw, texh, transformed_pos, 27, 31, col_pink);
    render_bone (ofstx, ofsty, texw, texh, transformed_pos, 31, 29, col_pink);
    render_bone (ofstx, ofsty, texw, texh, transformed_pos, 29, 27, col_pink);

    /* left leg */
    render_bone (ofstx, ofsty, texw, texh, transformed_pos, 24, 26, col_blue);
    render_bone (ofstx, ofsty, texw, texh, transformed_pos, 26, 28, col_blue);
    render_bone (ofstx, ofsty, texw, texh, transformed_pos, 28, 32, col_blue);
    render_bone (ofstx, ofsty, texw, texh, transformed_pos, 32, 30, col_blue);
    render_bone (ofstx, ofsty, texw, texh, transformed_pos, 30, 28, col_blue);
